...
const TaskModel = ({
  ...
  return (
    <div
      className={`fixed h-screen w-screen bg-black bg-opacity-50 top-0 flex items-center justify-center left-0 z-10 transition-all`}
    >
      <motion.div
      ...
      >
        ...
        <div
          onClick={() => setOpenTaskModel(false)}
